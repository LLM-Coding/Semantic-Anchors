...
|**Apache ECharts**
|Open-Source Visualisierungs-Library (Apache 2.0) für interaktive Charts, inkl. Treemap
...
|**Treemap**
|Hierarchische Visualisierung als verschachtelte Rechtecke, Größe = Wert
