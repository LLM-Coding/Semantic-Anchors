...
* **Code-Splitting**: Lazy Load Treemap, AsciiDoc Renderer
...
* Treemap Render Errors → Fallback zu Liste
...
* **Component Tests**: Treemap, Filter, Search Bar (Vitest + @testing-library)
...
<div role="region" aria-label="Treemap visualization of categories">
