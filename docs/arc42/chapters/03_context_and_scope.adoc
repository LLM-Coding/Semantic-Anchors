...
|**Website → Browser**
|Ausgabe
|Rendert Treemap, Anker-Details, Navigation
...
Container(treemap, "Treemap Component", "Apache ECharts", "Interaktive Visualisierung")
...
Rel(spa, treemap, "Verwendet für Visualisierung", "JavaScript")
...
SPA lädt JSON-Daten (fetch)
    ↓
Treemap rendert Visualisierung
    ↓
