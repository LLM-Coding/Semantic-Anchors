...
* **Visualisierung**: Treemap-basierte Darstellung der Kategorien nach MECE-Prinzip
...
* Interaktive Treemap-Visualisierung der Kategorien
...
|**Performance**
|ISO 25010
|Page Load < 2s auf 3G, Treemap-Rendering < 500ms. Langsame Seiten reduzieren Nutzung drastisch.
