...
*Lynn Cole — "Prompting with pre-computed priors".* Systems architect Lynn Cole coined this three-word framing for _why_ anchors work, quote-sharing the catalog on https://www.linkedin.com/posts/lynn-cole_these-are-outstanding-when-i-talk-about-share-7467744538934145025-zkUW/[LinkedIn] (2026): "When I talk about prompting with pre-computed priors, this is basically what I'm talking about." A well-known term does not _describe_ a concept — it _conditions_ the model toward a dense region its training already built, so a few tokens buy rich, consistent activation.
