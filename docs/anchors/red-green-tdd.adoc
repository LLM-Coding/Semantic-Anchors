...
* James O. Coplien, https://web.archive.org/web/20230923190457/https://rbcs-us.com/documents/Why-Most-Unit-Testing-is-Waste.pdf["Why Most Unit Testing is Waste"] (2013) — most low-level unit tests provide little assurance relative to their maintenance cost
* Empirical results are mixed: replication studies (e.g. Fucci et al., https://arxiv.org/abs/1611.05994["A Dissection of the Test-Driven Development Process"], IEEE TSE 2017) suggest observed benefits stem from working in small iterative steps rather than from writing the test first
====
