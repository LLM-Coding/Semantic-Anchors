...
:roles: software-architect, product-owner, consultant, educator, team-lead, data-scientist, systems-thinker, data-protection-officer, ethics-officer, legal-compliance
