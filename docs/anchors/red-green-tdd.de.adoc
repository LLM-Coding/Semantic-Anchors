...
* James O. Coplien, https://web.archive.org/web/20230923190457/https://rbcs-us.com/documents/Why-Most-Unit-Testing-is-Waste.pdf["Why Most Unit Testing is Waste"] (2013) — die meisten Low-Level-Unit-Tests liefern wenig Absicherung im Verhältnis zu ihren Wartungskosten
* Die empirische Lage ist gemischt: Replikationsstudien (z. B. Fucci et al., https://arxiv.org/abs/1611.05994["A Dissection of the Test-Driven Development Process"], IEEE TSE 2017) legen nahe, dass die beobachteten Vorteile aus kleinen iterativen Schritten stammen, nicht aus dem Schreiben des Tests zuerst
====
