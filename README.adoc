...
Browse the full catalog of 180+ semantic anchors with interactive visualization, search, and role-based filtering:
...
Filter anchors by role (see link:docs/roles/[`docs/roles/`] for detailed descriptions):
...
Semantic-Anchors/
├── docs/
│   ├── anchors/          # Individual anchor files (180+)
